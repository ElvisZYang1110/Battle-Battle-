...
class TestTask5(unittest.TestCase):
    ...
    def test__conduct_combat(self):
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
        try:
            self.assertEqual(str(t1.force), "Soldier's life = 2 and experience = 0", msg="Army 1 wrong for Fairer 1,0,0 0,1,0")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        try:
            self.assertEqual(str(t2.force), "Archer's life = 2 and experience = 0", msg="Army 2 wrong for Fairer 1,0,0 0")
        except AssertionError as e:
            self.verificationErrors.append(str(e))

        # your tests for __conduct_combat go here
        t1._Army__assign_army("", 5, 4, 4, formation)
        t2._Army__assign_army("", 4, 5, 4, formation)
        try:
            self.assertTrue(battle._Battle__conduct_combat(t1, t2, formation) == 2, "Fairer 5,4,4,4,5,4 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
    
        t1._Army__assign_army("", 1, 2, 3, formation)
        t2._Army__assign_army("", 4, 5, 6, formation)
        try:
            self.assertTrue(battle._Battle__conduct_combat(t1, t2, formation) == 2, "Fairer 1,2,3,4,5,6 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
